...
def find_gaps(exploded_input: List[Union[str, Blank]],
              ...
              split_char: str):
    index = 0
    cumulative = blank_type == Blank.DELETE
    # exploded_input will be modified directly during processing
    # working_exploded_input will only be modified during processing if cumulative
    ...
    while index < len(exploded_input):
        ...
        candidate = create_candidate(working_exploded_input, index, resume_index)
