...
class GrimoireFuzzer(Fuzzer):
    ...
    def generalize(self, input_data: bytes, new_edges: Set[Tuple[str, int, int]], splitting_rule=None):
        ...
        generalized_input = find_gaps(generalized_input, Blank.DELETE, create_delete_candidate, delete_candidate_check, increment_by_offset, 256)
        generalized_input = find_gaps(generalized_input, Blank.DELETE, create_delete_candidate, delete_candidate_check, increment_by_offset, 128)
        generalized_input = find_gaps(generalized_input, Blank.DELETE, create_delete_candidate, delete_candidate_check, increment_by_offset, 64)
        generalized_input = find_gaps(generalized_input, Blank.DELETE, create_delete_candidate, delete_candidate_check, increment_by_offset, 32)
        generalized_input = find_gaps(generalized_input, Blank.DELETE, create_delete_candidate, delete_candidate_check, increment_by_offset, 1)
        generalized_input = find_gaps(generalized_input, Blank.DELETE, create_delete_candidate, delete_candidate_check, find_next_char, '.')
        generalized_input = find_gaps(generalized_input, Blank.DELETE, create_delete_candidate, delete_candidate_check, find_next_char, ';')
        generalized_input = find_gaps(generalized_input, Blank.DELETE, create_delete_candidate, delete_candidate_check, find_next_char, ',')
        generalized_input = find_gaps(generalized_input, Blank.DELETE, create_delete_candidate, delete_candidate_check, find_next_char, '\n')
        generalized_input = find_gaps(generalized_input, Blank.DELETE, create_delete_candidate, delete_candidate_check, find_next_char, '\r')
        generalized_input = find_gaps(generalized_input, Blank.DELETE, create_delete_candidate, delete_candidate_check, find_next_char, '#')
        generalized_input = find_gaps(generalized_input, Blank.DELETE, create_delete_candidate, delete_candidate_check, find_next_char, ' ')
        generalized_input = find_gaps_in_closures(generalized_input, Blank.DELETE, create_delete_candidate, delete_candidate_check, find_closures, '(', ')')
        generalized_input = find_gaps_in_closures(generalized_input, Blank.DELETE, create_delete_candidate, delete_candidate_check, find_closures, '[', ']')
        generalized_input = find_gaps_in_closures(generalized_input, Blank.DELETE, create_delete_candidate, delete_candidate_check, find_closures, '{', '}')
        generalized_input = find_gaps_in_closures(generalized_input, Blank.DELETE, create_delete_candidate, delete_candidate_check, find_closures, '<', '>')
        generalized_input = find_gaps_in_closures(generalized_input, Blank.DELETE, create_delete_candidate, delete_candidate_check, find_closures, '\'', '\'')
